...
Jennifer ran this code on the MSU HPCC between January 12, 2020 and ____. 
...
This Pipeline uses USEARCH through OTU and ZOTU mapping and then QIIME2 for classification.
...
For this run, pairs merged consistently around 70% 
 Totals:
...
:00 4.8Mb  FASTQ base 33 for file combined_merged_both_runs.fastq
...
# 6A) Cluster into 0.97 OTUs using UPARSE and cluster_otus
...
```
23:23 285Mb   100.0% 29636 OTUs, 95239 chimeras
...
## 6B) Option 2: Identify ZOTUs using unoise3
